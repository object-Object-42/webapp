...
async def get_demo_podcast():
    ...
    try:
        ...
        file_path = (
            "/app/app/api/data/demo-podcast.mp3"  # Adjust this path as needed
        )
        ...
        return StreamingResponse(
            ...
            media_type="audio/mpeg",
            headers={
                "Content-Disposition": 'attachment; filename="demo-podcast.mp3"'
            },
        )

    except FileNotFoundError:
        raise HTTPException(
            status_code=404, detail="Demo podcast file not found"
        )
    except Exception as e:
        raise HTTPException(
